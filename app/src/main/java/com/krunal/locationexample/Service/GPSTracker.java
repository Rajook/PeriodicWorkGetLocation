...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        ...
        try {
            ...
            //getting network provider info
            gpsProvider = locationManager.getProvider(LocationManager.GPS_PROVIDER).getName();
            networkProvider = locationManager.getProvider(LocationManager.NETWORK_PROVIDER).getName();

            if (gpsProvider!=null){
                Log.d("GPS Provider Name", gpsProvider);
            }

            if (networkProvider!=null){
                Log.d("GPS Provider Name", networkProvider);
            }
